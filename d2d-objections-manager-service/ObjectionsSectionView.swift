...
struct ObjectionsSectionView: View {
    ...
    var body: some View {
        ScrollView {   // ✅ make it scrollable, pins to top
            ...
            .frame(maxWidth: .infinity, alignment: .topLeading) // ✅ stick to top
            .padding(.top, 12) // (optional) give a little breathing room under nav
        }
